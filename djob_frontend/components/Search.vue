  ...
  <div class="flex flex-col items-center justify-center my-4 mx-6">
    <div class="relative w-full max-w-lg mx-auto">
      <input
        ...
        class="w-full border-2 border-gray-300 bg-gray-50 h-12 px-4 pr-12 font-serif   rounded-lg  text-gray-900 focus:outline-none focus:border-yellow-500 focus:bg-white transition duration-300 ease-in-out hover:bg-gray-100 placeholder-gray-500"
        type="search"
        name="search"
        aria-label="Search"
